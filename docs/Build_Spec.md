```
This is the specification we used to scaffold this project with an AI coding agent (Google Antigravity). Kept here for transparency into our build process.
# TASK.md
